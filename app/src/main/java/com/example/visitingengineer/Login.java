...
public class Login extends AppCompatActivity {
    ...
    private CardView cv_loginEmail, cv_loginPwd;
    private Button btn_login;
    private TextView register_tv;
    private EditText login_email_edittext, login_pwd_edittext;
        ...
        mAuth.signInWithEmailAndPassword(email, pwd).addOnSuccessListener(new OnSuccessListener<AuthResult>() {
            ...
            public void onSuccess(AuthResult authResult) {
                if (authResult.getUser().isEmailVerified()) {
                    ...
                    Toast.makeText(Login.this, "Email not verified. Please verify it first.", Toast.LENGTH_LONG).show();
                                ...
                                public void onDataChange(DataSnapshot dataSnapshot) {
                                    if (dataSnapshot.exists()) {
                                        for (DataSnapshot child : dataSnapshot.getChildren()) {
                                            String uid = child.getValue(CustomerModel.class).getUid();
                                            startActivity(new Intent(Login.this, MainActivity.class));
                                            finish();
                                        ...
                                        CustomerModel customerModel = new CustomerModel(uid, userName, email);
                                        databaseRef.child(uid).setValue(customerModel);
